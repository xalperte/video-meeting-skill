...
```yaml
  ...
  vision_model: "qwen2.5vl:7b"        # local VLM for the optional frame-description step
```
...
```yaml
  ollama_models: ["gemma4:12b", "qwen3.5:9b", "qwen2.5vl:7b"]
```
...
class TestMigrateConfig(unittest.TestCase):
    ...
    def test_apply_preserves_customizations_and_adds_keys(self):
        ...
        with tempfile.TemporaryDirectory() as d:
            ...
            self.assertEqual(loaded["ollama"]["vision_model"], "qwen2.5vl:7b")
